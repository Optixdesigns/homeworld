...
public class Perimeter : MonoBehaviour, IList<Target>
{
    ...
    private IEnumerator UpdateSort()
    {
        ...
        {
            // Sort if the list was changed or if the counter is 0.
            ...
            if (!this.dirty && intervalCounter > 0)
            {
                // The counter isn't high enough yet
            ...
            // Use a minimal wait just to scale with Time.timeScale and skip a few iterations.
            //  This is based on the requested interval because that scales with need.
            yield return new WaitForSeconds(this.targetTracker.sortInterval * 0.2f);
        }
    }
    #endregion Events
