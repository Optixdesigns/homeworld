...
public class TargetTracker : MonoBehaviour
{
    ...
    /// <summary>
    /// How often the target list will be sorted
    /// </summary>
    public float sortInterval = 1f;

    /// <summary>
    /// The range in which targets will be found.
    /// The size from the center to the edge of the perimeter in x, y and z for any shape.
    /// Depending on the shape some values may be ignored. E.g. Spheres only use X for radius
    /// </summary>
    ...
    public TargetList targets
    {
        get 
        {
            ...
            {
                string msg = string.Format("returning targets: {0}", this._targets.ToString());
    ...
    private TargetList _targets = new TargetList();
