...
#public static def GetClasses(baseType as Type) as List[of Type]:
    #return System.Reflection.Assembly.GetCallingAssembly().GetTypes().Where(type.IsSubclassOf(baseType)).ToList()
